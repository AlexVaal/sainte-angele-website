...
function proxy(request) {
    ...
    if (pathname === "/fr/location-de-salle") {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].rewrite(new URL("/fr/hall-rental", request.url));
    }
    if (pathname === "/fr/hall-rental") {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL("/fr/location-de-salle", request.url));
    }
